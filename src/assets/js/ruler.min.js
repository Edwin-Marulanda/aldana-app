"use strict";
var ruler = function (a) { this.api = this.builder(), this.api.constructRulers.call(this, a) };

ruler.prototype.builder = function () {
    var a, b = 1, c = 2, d = 0, e = 0, f = 1, g = {}, h = [],
        i = document.createElement("div"),
        j = [],
        k = {
            rulerHeight: 15, fontFamily: "arial",
            fontSize: "8px", strokeStyle: "gray",
            sides: ["top", "left"],
            cornerSides: ["TL"], lineWidth: 1, enableMouseTracking: !0, enableToolTip: !0
        },
        l = function (a, b) {
            var c = "rotate(" + b + "deg)",

                d = ruler.prototype.utils.pixelize(Math.abs(parseInt(a.canvas.style.left))) + " 100%";
            a.canvas.style.webkitTransform = c,
                a.canvas.style.MozTransform = c, a.canvas.style.OTransform = c, a.canvas.style.msTransform = c, a.canvas.style.transform = c, a.canvas.style.webkitTransformOrigin = d, a.canvas.style.MozTransformOrigin = d, a.canvas.style.OTransformOrigin = d, a.canvas.style.msTransformOrigin = d, a.canvas.style.transformOrigin = d
        }, 
        m = function (a, b) { 
            switch (a.canvas.style.left = ruler.prototype.utils.pixelize(-(a.canvas.width / 2 - a.canvas.height)), b) 
            { 
                case "top": 
                a.orgPos = parseInt(a.canvas.style.left); 
                break; 
                case "left": 
                a.canvas.style.top = ruler.prototype.utils.pixelize(-a.canvas.height - 1), 
                a.orgPos = parseInt(a.canvas.style.top), l(a, 90) } }, 
                n = function (a, b) { 
                    var c = function (a) { 
